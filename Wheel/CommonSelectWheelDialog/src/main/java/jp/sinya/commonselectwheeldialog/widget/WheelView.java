...
import jp.sinya.commonselectwheeldialog.widget.adapter.WheelViewAdapter;
import jp.sinya.commonselectwheeldialog.widget.bean.ItemsRange;
...
public class WheelView extends View {
    ...
    private void initResourcesIfNecessary() {
        if (centerDrawable == null) {
            centerDrawable = getContext().getResources().getDrawable(R.drawable.shape_common_select_wheel_val);
        }
        ...
        setBackgroundResource(R.drawable.shape_common_select_wheel_bg);
    }
