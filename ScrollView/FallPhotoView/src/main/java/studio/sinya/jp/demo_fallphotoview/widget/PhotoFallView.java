...
import studio.sinya.jp.demo_fallphotoview.ImageLoader;
 ...
 */
public class PhotoFallView extends ScrollView implements View.OnTouchListener {
    ...
    private static Handler handler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            PhotoFallView myScrollView = (PhotoFallView) msg.obj;
     ...
     * @param attrs
     */
    public PhotoFallView(Context context, AttributeSet attrs) {
        super(context, attrs);
