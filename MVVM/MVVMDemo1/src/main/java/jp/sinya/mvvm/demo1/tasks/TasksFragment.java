...
import jp.sinya.mvvm.demo1.ScrollChildSwipeRefreshLayout;
import jp.sinya.mvvm.demo1.data.Task;
import jp.sinya.mvvm.demo1.data.source.TasksRepository;
import jp.sinya.mvvm.demo1.databinding.TaskItemBinding;
import jp.sinya.mvvm.demo1.databinding.TasksFragBinding;
...
public class TasksFragment extends Fragment {
    ...
    private void setupListAdapter() {
        ...
        mListAdapter = new TasksAdapter(new ArrayList<Task>(0), (TasksActivity) getActivity(), Injection.provideTasksRepository(getContext().getApplicationContext()), mTasksViewModel);
    ...
    public static class TasksAdapter extends BaseAdapter {
        ...
        public TasksAdapter(List<Task> tasks, TasksActivity taskItemNavigator, TasksRepository tasksRepository, TasksViewModel tasksViewModel) {
