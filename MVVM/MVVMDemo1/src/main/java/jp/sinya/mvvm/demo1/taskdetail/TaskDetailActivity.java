...
package jp.sinya.mvvm.demo1.taskdetail;
...
import jp.sinya.mvvm.demo1.Injection;
import jp.sinya.mvvm.demo1.R;
import jp.sinya.mvvm.demo1.ViewModelHolder;
import jp.sinya.mvvm.demo1.addedittask.AddEditTaskActivity;
import jp.sinya.mvvm.demo1.addedittask.AddEditTaskFragment;
import jp.sinya.mvvm.demo1.util.ActivityUtils;

import static jp.sinya.mvvm.demo1.addedittask.AddEditTaskActivity.ADD_EDIT_RESULT_OK;
import static jp.sinya.mvvm.demo1.taskdetail.TaskDetailFragment.REQUEST_EDIT_TASK;
...
public class TaskDetailActivity extends AppCompatActivity implements TaskDetailNavigator {
    ...
    private TaskDetailViewModel findOrCreateViewModel() {
        ...
        // Fragment Manager.
        @SuppressWarnings("unchecked") ViewModelHolder<TaskDetailViewModel> retainedViewModel = (ViewModelHolder<TaskDetailViewModel>) getSupportFragmentManager().findFragmentByTag(TASKDETAIL_VIEWMODEL_TAG);
        ...
        if (retainedViewModel != null && retainedViewModel.getViewmodel() != null) {
            ...
            TaskDetailViewModel viewModel = new TaskDetailViewModel(getApplicationContext(), Injection.provideTasksRepository(getApplicationContext()));

            // and bind it to this Activity's lifecycle using the Fragment Manager.
            ActivityUtils.addFragmentToActivity(getSupportFragmentManager(), ViewModelHolder.createContainer(viewModel), TASKDETAIL_VIEWMODEL_TAG);
            return viewModel;
        }
    }
