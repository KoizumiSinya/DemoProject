...
public class StatisticsActivity extends AppCompatActivity {
    ...
    private StatisticsViewModel findOrCreateViewModel() {
        ...
        // Fragment Manager.
        @SuppressWarnings("unchecked") ViewModelHolder<StatisticsViewModel> retainedViewModel = (ViewModelHolder<StatisticsViewModel>) getSupportFragmentManager().findFragmentByTag(STATS_VIEWMODEL_TAG);
        ...
        if (retainedViewModel != null && retainedViewModel.getViewmodel() != null) {
            ...
            StatisticsViewModel viewModel = new StatisticsViewModel(getApplicationContext(), Injection.provideTasksRepository(getApplicationContext()));

            // and bind it to this Activity's lifecycle using the Fragment Manager.
            ActivityUtils.addFragmentToActivity(getSupportFragmentManager(), ViewModelHolder.createContainer(viewModel), STATS_VIEWMODEL_TAG);
            return viewModel;
        }
    }
