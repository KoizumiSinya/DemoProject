package com.example.demo_contactasyncqueryhandler.utils;
...
public class LogUtils {
	 ...
	 * DEBUG为false，即使不把代码中的LogUtils方法删除或者注释掉，也可以让它不再打印信息
	 */
    ...
    public static void I(String tag, String msg) {
        if (DEBUG) {
            ...
            String head = stackTrace.getClassName() + "." + stackTrace.getMethodName() + "()" + stackTrace.getLineNumber() + " ";
