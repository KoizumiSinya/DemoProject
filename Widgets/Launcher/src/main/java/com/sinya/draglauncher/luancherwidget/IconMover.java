package com.sinya.draglauncher.luancherwidget;
...
import com.sinya.draglauncher.luancherwidget.manager.BitmapManager;
...
public class IconMover {
    ...
    private void drawIcon(Bitmap bitmap) {
        ...
        app.drawBoundIcon(lc, op, canvas, lc.fullMarginLeftBlackCircle, lc.cMarginTop, op.getPaintTextBlack(), darkPaint);
    }
    ...
    private Bitmap getImageBitmap() {
        ...
        if (image != null && image.get() != null) {
            ...
            bitmap = BitmapManager.createBitmap(lc.getIconWidth() + lc.gapH, lc.itemHeight + top, Bitmap.Config.ARGB_8888);
    ...
    public void moveIntoFolder(int x, int y, final OnMovingStopped onMovingStopped) {
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            public void onAnimationEnd(Animation paramAnimation) {
                ...
                app = null;
                if (onMovingStopped != null) onMovingStopped.movingStopped(appInfo);
                handler.post(hider);
            }
    ...
    public void stopMoving(int x, int y, final OnMovingStopped onMovingStopped) {
        ...
        if (onMovingStopped != null) animation.setAnimationListener(new Animation.AnimationListener() {
