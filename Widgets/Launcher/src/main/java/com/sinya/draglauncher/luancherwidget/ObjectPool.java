...
public class ObjectPool {
    ...
    public Bitmap getBitmapBlackCircle() {
        ...
        if (bitmapBlackCircle != null) {
            ...
            bitmap = BitmapFactory.decodeResource(context.getResources(), R.mipmap.black_circle_x);
        }
        return bitmap;
    }
    ...
    public Bitmap getFolderIcon() {
        ...
        if (bitmapFolder != null && bitmapFolder.get() != null) {
            ...
            bitmap = stretch(BitmapManager.getBitmap(this.context, R.mipmap.folder));
    ...
    public Bitmap stretch(Bitmap bitmap, float scaled) {
        ...
        if (bitmap.getWidth() != lc.iconWidth * scaled || bitmap.getHeight() != lc.iconHeight * scaled) {
            bitmap = BitmapManager.createScaledBitmap(bitmap, (int) (lc.iconWidth * scaled), (int) (lc.iconHeight * scaled), true);
        }
        return bitmap;
    }
}
