package com.sinya.draglauncher.luancherwidget.view;
...
public class FolderView extends RelativeLayout {
    ...
    private void init(LayoutCalculator lc, int screenHeight) {
        ...
        LayoutParams params = new LayoutParams((lc.iconWidth + lc.gapH) * 3, screenHeight - lc.dpToPixel(40) - 4 * lc.folderMargin);
        //居中
    ...
    public void onReday(LayoutCalculator lc, ObjectPool pp, int screenHeight) {
        ...
        if (mContentView == null) {
            ...
            mFolderContainer.addView(mContentView, LinearLayout.LayoutParams.MATCH_PARENT, mContentView.getViewHeight());
        } else {
