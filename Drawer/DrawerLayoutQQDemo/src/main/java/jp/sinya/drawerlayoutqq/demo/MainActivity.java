package jp.sinya.drawerlayoutqq.demo;
...
public class MainActivity extends AppCompatActivity {
    ...
    private int[] tabIcons = {R.mipmap.ngq, R.mipmap.nti, R.mipmap.nbb};
    ...
    private void initView() {
        ...
        ObjectAnimator animator = ObjectAnimator.ofFloat(ivDrawerBg, "translationY", curTranslationY, -70f, 60, curTranslationY);
...
//        tabLayout.addTab(tabLayout.newTab().setIcon(tabIcons[2]));
        ...
        MyFragmentPagerAdapter adapter = new MyFragmentPagerAdapter(getSupportFragmentManager(), tabIcons, this);
