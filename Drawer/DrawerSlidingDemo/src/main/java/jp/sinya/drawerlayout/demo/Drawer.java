...
public class Drawer extends LinearLayout {
    ...
    public Drawer(Context context, AttributeSet attrs) {
        ...
        if (mHandleId == -1) {
            e = new IllegalArgumentException(a.getPositionDescription() + ": 抽屉把手必须制定一个子View");
        }
        mContentId = a.getResourceId(R.styleable.Drawer_drawer_content, -1);
        if (mContentId == -1) {
            e = new IllegalArgumentException(a.getPositionDescription() + ": 抽屉内容必须制定一个子View");
        }
        ...
        openWidth = a.getDimensionPixelOffset(R.styleable.Drawer_drawer_handle_openWidth, dip2px(context, 65));
        closeWidth = a.getDimensionPixelOffset(R.styleable.Drawer_drawer_handle_closeWidth, dip2px(context, 30));
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mContentWidth != 0 && mState == State.CLICK && mHandle.getTag().equals(TAG_OPEN)) {
