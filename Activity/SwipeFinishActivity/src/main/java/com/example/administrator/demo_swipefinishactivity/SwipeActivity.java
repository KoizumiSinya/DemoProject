package com.example.administrator.demo_swipefinishactivity;
...
public class SwipeActivity extends Activity {
    ...
    class SwipeLayout extends FrameLayout {
        ...
        private void animateFromVelocity(float v) {
            if (v > 0) {
                if (content.getX() < screenWidth / 2 && v * duration / 1000 + content.getX() < screenWidth) {
                    animateBack(false);
                } else {
                    animateFinish(true);
                }
            } else {
                if (content.getX() > screenWidth / 2 && v * duration / 1000 + content.getX() > screenWidth / 2) {
                    animateFinish(false);
                } else {
                    animateBack(true);
                }
