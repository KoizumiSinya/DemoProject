...
public abstract class SwipeBaseActivity extends AppCompatActivity {
        ...
        SwipeBackHelper.getCurrentPage(this)//获取当前页面
                ...
                .addListener(new SwipeListener() {//滑动监听
                    ...
                    public void onEdgeTouch() {//当开始滑动
                        Utils.convertActivityToTranslucent(SwipeBaseActivity.this);
                    }
                    ...
                    public void onScrollStateChange(int state, float px) {
                        if (state == SwipeBackLayout.STATE_IDLE && px == 0) {
                            Utils.convertActivityFromTranslucent(SwipeBaseActivity.this);
                        }
                    }
                });
    }
    ...
    public void startActivity(Intent intent) {
        ...
        overridePendingTransition(R.anim.lib_res_anim_activity_in_from_right, R.anim.lib_res_anim_activity_out_to_left);
    }

    @Override
    public void finish() {
        super.finish();
        overridePendingTransition(R.anim.lib_res_anim_activity_in_from_left, R.anim.lib_res_anim_activity_out_to_right);
    }
