package jp.sinya.swipeback.demo.library3.core.helper.internal;
...
public class VisibleDelegate {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (!mInvisibleWhenLeave && !mFragment.isHidden() && mFragment.getUserVisibleHint()) {
            if ((mFragment.getParentFragment() != null && isFragmentVisible(mFragment.getParentFragment())) || mFragment.getParentFragment() == null) {
                mNeedDispatch = false;
