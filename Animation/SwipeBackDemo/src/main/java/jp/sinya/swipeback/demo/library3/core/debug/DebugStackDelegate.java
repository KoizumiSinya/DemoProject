package jp.sinya.swipeback.demo.library3.core.debug;
...
import jp.sinya.swipeback.demo.library3.core.Fragmentation;
...
public class DebugStackDelegate implements SensorEventListener {
    ...
    public void showFragmentStackHierarchyView() {
        ...
        mStackDialog = new AlertDialog.Builder(mActivity).setView(container).setPositiveButton(android.R.string.cancel, null).setCancelable(true).create();
        mStackDialog.show();
    }
