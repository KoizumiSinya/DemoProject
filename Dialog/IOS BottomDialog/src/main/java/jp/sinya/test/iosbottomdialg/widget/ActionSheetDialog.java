package jp.sinya.test.iosbottomdialg.widget;
...
import com.spd.mobile.utils.UIUtils;
...
public class ActionSheetDialog extends BottomBaseDialog {
    ...
    public void setUiBeforShow() {
        ...
        tv_title.setBackgroundDrawable(UIUtils.cornerDrawable(titleBgColor, new float[]{radius, radius, radius, radius, 0, 0, 0, 0}));
        ...
        if (isTitleShow) {
            lv.setBackgroundDrawable(UIUtils.cornerDrawable(lvBgColor, new float[]{0, 0, 0, 0, radius, radius, radius, radius}));
        } else {
    ...
    class ListDialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            float radius = dp2px(cornerRadius_DP);
            if (isTitleShow) {
                ll_item.setBackgroundDrawable((UIUtils.listItemSelector(radius, Color.TRANSPARENT, itemPressColor, position == contents.size() - 1)));
            } else {
                ll_item.setBackgroundDrawable(UIUtils.listItemSelector(radius, Color.TRANSPARENT, itemPressColor, contents.size(), position));
            }
