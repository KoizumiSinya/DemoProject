package jp.sinya.mvpdemo2.simple.demo15.animator.impl;
...
public class AnimatorUtils {
    ...
    public void showErrorView(@NonNull final View loadingView, @NonNull final View contentView, final View errorView) {
    ...
    public void showContent(final View loadingView, final View contentView, @NonNull final View errorView) {
