...
import jp.sinya.mvpdemo2.simple.demo11.BaseButton_11;
...
public class LoginButton_11 extends BaseButton_11<LoginView_8, LoginPresenter_8> implements LoginView_8, View.OnClickListener {

    public LoginButton_11(Context context) {
        super(context);
    }

    public LoginButton_11(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
