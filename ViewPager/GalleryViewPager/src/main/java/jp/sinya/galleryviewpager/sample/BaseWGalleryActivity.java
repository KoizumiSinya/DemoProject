...
import jp.sinya.galleryviewpager.gallery.WGallery;

/**
 * @author wuzhen
 * @version Version 1.0, 2016-05-10
 */
public class BaseWGalleryActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener, SeekBar.OnSeekBarChangeListener {
