...
import jp.sinya.stickylayoutdemo.widget.SimpleViewPagerIndicator;
...
public class MainActivity2 extends FragmentActivity {
    ...
    private TabFragment2[] mFragments = new TabFragment2[mTitles.length];
    ...
    private void initDatas() {
        ...
        for (int i = 0; i < mTitles.length; i++) {
            mFragments[i] = TabFragment2.newInstance(mTitles[i]);
        }
