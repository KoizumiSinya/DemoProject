...
import jp.sinya.refreshframework.swipemenulistview.SwipeMenuListView;

/**
 * @author KoizumiSinya
 * @date 2016/05/26.
 */
public class PullableSwipeMenuListView extends SwipeMenuListView implements Pullable{
    ...
    public PullableSwipeMenuListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
