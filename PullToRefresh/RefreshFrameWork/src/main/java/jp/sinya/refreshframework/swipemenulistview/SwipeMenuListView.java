package jp.sinya.refreshframework.swipemenulistview;
...
public class SwipeMenuListView extends ListView {
    ...
    public SwipeMenuListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.SwipeMenuListView);
        mRightViewWidth = (int) typedArray.getDimension(R.styleable.SwipeMenuListView_right_width, 200);
        typedArray.recycle();
    }
