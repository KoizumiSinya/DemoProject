...
public class VerticalActivity extends Activity {
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                MatrixView m = (MatrixView) LayoutInflater.from(VerticalActivity.this).inflate(R.layout.view_list_item, null);
                // View m =
                // LayoutInflater.from(MainActivity.this).inflate(R.layout.view_list_item_test,
                // null);
                m.setParentHeight(lv.getHeight());
                m.setParentWidth(lv.getWidth());
                convertView = m;
            }
            convertView.findViewById(R.id.back_view).setVisibility(View.GONE);
            ((MatrixView) convertView).setMode(MatrixView.MODE_VERTICAL);
