 ...
 * @author Dean.Ding
 *         <p>
 *         It override ImageView's onDraw , so , some ImageView's origin
 *         function can not work: 1. DrawMatrix is disabled 2. CropToPadding is
 *         useless 3. It will be always work in CenterCrop mode!!!!!!
 */
