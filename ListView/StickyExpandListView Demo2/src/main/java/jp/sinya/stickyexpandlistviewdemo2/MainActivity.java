...
import jp.sinya.stickyexpandlistviewdemo2.widget.PinnedHeaderExpandableListView;
import jp.sinya.stickyexpandlistviewdemo2.widget.PinnedHeaderExpandableListView.OnHeaderUpdateListener;
...
public class MainActivity extends Activity
    ...
    public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
        Toast.makeText(MainActivity.this, childList.get(groupPosition).get(childPosition).getName(), Toast.LENGTH_SHORT).show();
