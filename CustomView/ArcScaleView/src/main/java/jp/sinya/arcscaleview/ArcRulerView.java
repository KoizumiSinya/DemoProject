...
public class ArcRulerView extends View {
    ...
    private float mEveryScaleValue = 1;//每滑动多少度,值得增加

    private int mScaleNumber = 5;//刻度数量
    ...
    public ArcRulerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setClickable(true);
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        mEveryScaleValue = typedArray.getFloat(R.styleable.ArcScaleView_everyScaleValue, 1);
    ...
    private void drawArc(Canvas canvas) {
        ...
        mArcPath.addCircle(mWidth / 2, mHeight * 1.6f, radius, Path.Direction.CCW);
    ...
    private void drawScale(Canvas canvas) {
        ...
        PathMeasure arcPathMeasure = new PathMeasure();
        arcPathMeasure.setPath(mArcPath, false);
        ...
        for (int i = 1; i <= mScaleNumber; i++) {
            ...
            arcPathMeasure.getPosTan(arcPathMeasure.getLength() * percentage, pos, tan);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (isTouch(mTouchX, mTouchY)) {
                    ...
                    long addValue = Math.round(tempAngle * mEveryScaleValue);
    ...
    public void setEvenyScaleValue(float everyScaleValue) {
        this.mEveryScaleValue = everyScaleValue;
    }
