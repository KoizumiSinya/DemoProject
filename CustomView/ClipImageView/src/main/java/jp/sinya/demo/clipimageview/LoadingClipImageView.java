...
public class LoadingClipImageView extends ImageView {
    ...
    public LoadingClipImageView(Context context) {
        super(context);
        init();
    }

    public LoadingClipImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
        initAttrs(context, attrs);
    }

    public LoadingClipImageView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        TypedArray t = context.obtainStyledAttributes(attrs, R.styleable.LoadingClipImageView);
        mMaskColor = t.getColor(R.styleable.LoadingClipImageView_clip_color, mMaskColor);
        mIsAutoStart = t.getBoolean(R.styleable.LoadingClipImageView_clip_anim, mIsAutoStart);
