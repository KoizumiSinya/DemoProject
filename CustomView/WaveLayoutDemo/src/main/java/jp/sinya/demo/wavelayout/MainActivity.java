...
import jp.sinya.demo.wavelayout.widget.CanRippleLayout;
import jp.sinya.demo.wavelayout.widget.CanShadowDrawable;
import jp.sinya.demo.wavelayout.widget.CanWaterWaveLayout;
import jp.sinya.demo.wavelayout.widget.ViewAnimationUtils;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CanShadowDrawable.Builder//
                .on(fl2)//
                .radius(dp2Px(10))//
                .shadowColor(Color.parseColor("#333333"))//
                .shadowRange(dp2Px(5))//
                /*.offsetTop(dp2Px(5))*/.offsetBottom(dp2Px(5))//
                .offsetLeft(dp2Px(5))//
                .offsetRight(dp2Px(5))//
                .create();
        ...
        view4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Animator c1a = ViewAnimationUtils.createCircularReveal(view3, 0, 0, (int) dp2Px(100), 1000);
        ...
        view3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Animator c1a = ViewAnimationUtils.createCircularReveal(view3, 0, 0, 1000, (int) dp2Px(100));
                c1a.setDuration(1000);
                c1a.setInterpolator(new AccelerateDecelerateInterpolator());
                c1a.start();
    ...
    private void initView1() {
        View view1 = findViewById(R.id.activity_main_view1);
        View fl1 = findViewById(R.id.activity_main_fl1);
//                CanShadowDrawable.Builder//
//                .on(fl1)//
//                .radius(dp2Px(5))//
//                .shadowColor(Color.parseColor("#333333"))//
