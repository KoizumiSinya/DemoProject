...
import jp.sinya.refreshlibrary.R;
...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    private void initView(Context context) {
        ...
        rotateAnimation = (RotateAnimation) AnimationUtils.loadAnimation(context, R.anim.refresh_anim_reverse);
        refreshingAnimation = (RotateAnimation) AnimationUtils.loadAnimation(context, R.anim.refresh_anim_rotating);
        // 添加匀速转动动画
    ...
    public void loadmoreFinish(int refreshResult) {
        if (loadingView == null || loadStateImageView == null || loadStateTextView == null) {
            return;
        }
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                loadStateImageView.setBackgroundResource(R.drawable.refresh_load_succeed);
                break;
            case FAIL:
            default:
                // 加载失败
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        switch (ev.getActionMasked()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (xDiff > yDiff) {
                    pullView.dispatchTouchEvent(ev);
                } else {
    ...
    /**
     * Sinya
     * 适用于listview类的滑到底部自动加载
     *
     * @param view
     */
    public void autoLoadView(ListView view) {
                    ...
                    case AbsListView.OnScrollListener.SCROLL_STATE_IDLE:
                        if (view.getLastVisiblePosition() == (view.getCount() - 1)) {
                            ...
                            if (view.getChildAt(view.getLastVisiblePosition() - view.getFirstVisiblePosition()) != null//
                                    && view.getChildAt(view.getLastVisiblePosition() - view.getFirstVisiblePosition()).getBottom() <= view.getMeasuredHeight()) {
                                autoLoad();
                            }
                        }
                        break;
    ...
    private void initView() {
        // 初始化下拉布局
        pullView = refreshView.findViewById(R.id.refresh_pull_icon);
        refreshStateTextView = (TextView) refreshView.findViewById(R.id.refresh_state_tv);
        refreshingView = refreshView.findViewById(R.id.refresh_refreshing_icon);
        refreshStateImageView = refreshView.findViewById(R.id.refresh_state_iv);
        // 初始化上拉布局
        pullUpView = loadmoreView.findViewById(R.id.refresh_pullup_icon);
        loadStateTextView = (TextView) loadmoreView.findViewById(R.id.refresh_loadstate_tv);
        loadingView = loadmoreView.findViewById(R.id.refresh_loading_icon);
        loadStateImageView = loadmoreView.findViewById(R.id.refresh_loadstate_iv);
    }
