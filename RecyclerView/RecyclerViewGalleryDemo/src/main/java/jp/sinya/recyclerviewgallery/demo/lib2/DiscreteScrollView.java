...
import jp.sinya.recyclerviewgallery.demo.lib2.util.ScrollListenerAdapter;
...
public class DiscreteScrollView extends RecyclerView {
    ...
    private void init(AttributeSet attrs) {
        ...
        layoutManager = new DiscreteScrollLayoutManager(getContext(), new ScrollStateListener(), DSVOrientation.values()[orientation]);
    ...
    private void notifyScroll(float position, int currentIndex, int newIndex, ViewHolder currentHolder, ViewHolder newHolder) {
        for (ScrollStateChangeListener listener : scrollStateChangeListeners) {
    ...
    private class ScrollStateListener implements DiscreteScrollLayoutManager.ScrollStateListener {
        ...
        public void onScroll(float currentViewPosition) {
            ...
            if (currentIndex != newIndex) {
                notifyScroll(currentViewPosition, currentIndex, newIndex, getViewHolder(currentIndex), getViewHolder(newIndex));
            }
        }
    ...
    public interface ScrollStateChangeListener<T extends ViewHolder> {
        ...
        void onScroll(float scrollPosition, int currentPosition, int newPosition, @Nullable T currentHolder, @Nullable T newCurrent);
    }
